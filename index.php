...
<?php if ( have_posts() ) : ?>
	...
	$UeneoTheme_blog_header = $UeneoTheme_Options->get('ut_blog_header');
	$UeneoTheme_blog_sub_header = $UeneoTheme_Options->get('ut_posts_page_sub');  
	...
	<header class="<?php echo $UeneoTheme_header_class; ?>" style="background:url('<?php echo $UeneoTheme_blog_header; ?>');" data-0="background-position:0px 0px;" data-300="background-position:0px 100px;">
		...
		<div class="grid">
			<div class="c12 end">
				<h1 class="page-title underline"><?php $UeneoTheme_Options->show('ut_posts_page'); ?></h1>

				<?php if(!empty($UeneoTheme_blog_sub_header)){
					echo '<h2><em>'.$UeneoTheme_blog_sub_header.'</em></h2>';
				} ?>
