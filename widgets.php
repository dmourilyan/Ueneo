...
add_action('widgets_init', 'ueneotheme_flickr_photos_widget');

function ueneotheme_flickr_photos_widget()
{
    register_widget('UeneoTheme_Flickr_Widget');
}

class UeneoTheme_Flickr_Widget extends WP_Widget {

    function UeneoTheme_Flickr_Widget()
    {
        $widget_ops = array('classname' => 'flickr', 'description' => 'The most recent photos from flickr.');

        $control_ops = array('id_base' => 'flickr-widget');

        $this->WP_Widget('flickr-widget', 'Ueneo Flickr', $widget_ops, $control_ops);
    }
    ...
    function widget($args, $instance)
    {
        ...
        function jsonFlickrApi(rsp) {
            ...
            for (var i=0; i < rsp.photos.photo.length; i++) {
                ...
                p_url = "https://www.flickr.com/photos/" +
    ...
    {
        $defaults = array('title' => 'Flickr', 'screen_name' => '', 'number' => 6, 'api' => 'c9d2c2fda03a2ff487cb4769dc0781ea');
